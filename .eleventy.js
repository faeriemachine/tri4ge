module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addCollection('recentPosts', function(collectionApi) {
    return collectionApi.getFilteredByGlob('src/blog/posts/**/*.md').reverse().slice(0, 5);

  });


  eleventyConfig.addCollection("recentArt", function(collectionApi) {
    return collectionApi.getFilteredByGlob("src/gallery/*.md").reverse().slice(0, 10);
  });
